...
renderer = Mittsu::OpenGL::Renderer.new width: SCREEN_WIDTH, height: SCREEN_HEIGHT, title: '05 Earth Example'
...
texture = Mittsu::ImageUtils.load_texture(File.join File.dirname(__FILE__), 'assets/moon.png')
material = Mittsu::MeshLambertMaterial.new(map: texture)
