...
map_a = Mittsu::ImageUtils.load_texture(File.join File.dirname(__FILE__), 'assets/sprite0.png')
...
map_b = Mittsu::ImageUtils.load_texture(File.join File.dirname(__FILE__), 'assets/sprite1.png')
map_c = Mittsu::ImageUtils.load_texture(File.join File.dirname(__FILE__), 'assets/sprite2.png')
...
renderer = Mittsu::OpenGL::Renderer.new width: SCREEN_WIDTH, height: SCREEN_HEIGHT, title: '14 Sprite Example'
