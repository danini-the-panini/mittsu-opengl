...
renderer = Mittsu::OpenGL::Renderer.new width: screen_width, height: screen_height, title: '15 Raycast OBJ Example'
...
object = loader.load(File.expand_path('../assets/male02.obj', __FILE__), 'male02.mtl')
