...
class TestRBSLLoader < Minitest::Test
  ...
  def test_load_shader
    loaded_shader = Mittsu::OpenGL::Shader::RBSLLoader.load_shader(TEST_VERTEX, TEST_CHUNKS)

    assert_equal(EXPECTED_VERTEX, loaded_shader)

    loaded_shader = Mittsu::OpenGL::Shader::RBSLLoader.load_shader(TEST_FRAGMENT, TEST_CHUNKS)

    assert_equal(EXPECTED_FRAGMENT, loaded_shader)
  end

  def test_load_uniforms
    loaded_uniforms = Mittsu::OpenGL::Shader::RBSLLoader.load_uniforms(TEST_UNIFORMS, TEST_UNIFORM_LIB)
  ...
  def test_load_custom_uniforms
    loaded_uniforms = Mittsu::OpenGL::Shader::RBSLLoader.load_uniforms(TEST_CUSTOM_UNIFORMS, TEST_UNIFORM_LIB)
